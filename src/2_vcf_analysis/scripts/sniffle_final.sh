...
for sample in "${sample_list[@]}";do
    ...
    /public/home/xiayini/anaconda3/bin/python \
    /public/home/xiayini/project/nanopore_ATRX/2_vcf_analysis/scripts/sniffle_final.py $sample
...
# step2: sniffles
sniffles --input $input_bam --reference $refer_fasta_file --tandem-repeats $refer_repeat_bed_ch38 --minsupport 2 --vcf $output_vcf --output-rnames
