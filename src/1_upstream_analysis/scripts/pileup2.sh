...
path=/public/home/xiayini/project/nanopore_ATRX/1_upstream_analysis/results/a509_2
...
for chr in {10..22};do
$samtools mpileup $bam_file -f $reference_fa -r chr${chr} --output-mods -o $path/chr${chr}.pileup
