...
path="/public/home/xiayini/project/nanopore_ATRX/2_vcfV3_analysis/data/joint_multi/"
# 定义样本ID和对应的bed文件
sample1="s31222_a509"
...
new_sample_files = {
    "ATRX-P0": f"{path}difference_{sample1}/",
    "ATRX-P7": f"{path}difference_{sample2}/",
    "ATRX-P16": f"{path}difference_{sample3}/"
}
...
# 将结果写入CSV文件
with open('/public/home/xiayini/project/nanopore_ATRX/5_statistc/scripts/SV_new.csv',
           'w', newline='') as csvfile:
    csvwriter = csv.writer(csvfile)
    
    # 写入CSV文件头部
    # ['BND',"DEL",'DUP','INS','INV']
    csvwriter.writerow(['SampleID', 'new_total_SV',
                        'new_BND_SV','new_DEL_SV', 'new_DUP_SV','new_INS_SV',
                        'new_INV_SV','missing_total_SV','missing_BND_SV',
                        'missingDEL_SV', 'missing_DUP_SV','missing_INS_SV','missing_INV_SV'])
